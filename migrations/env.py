...
# Add the application directory to the path so we can import our models
...
# Create Flask app and get database metadata
    ...
    with flask_app.app_context():
        ...
        with connectable.connect() as connection:
            context.configure(
                ...
                target_metadata=target_metadata,
                compare_type=True,  # Compare column types for better migration detection
